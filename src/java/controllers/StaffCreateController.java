...
public class StaffCreateController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StaffCreateController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StaffCreateController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (login == null) {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("views/admin/StaffCreate.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (login == null) {
            ...
            dao.CreateUser(new User(uName, psd, fullname, new Role(rID, rName), true));
            UserProfilesDAO uspdao = new UserProfilesDAO();
            uspdao.CreateUserProfile(new UserProfile(uName, fullname, email, phone, adr, date, gender));
            response.sendRedirect("Staff");
        }
    }
