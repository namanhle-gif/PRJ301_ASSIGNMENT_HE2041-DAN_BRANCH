                    ...
                    <tr>
                        ...
                        <td>
                            <select onchange="handleAction(this)">
                                ...
                                <option value="detail-${pageScope.accounts.getUsername()}">Details</option>
                                <option value="edit-${pageScope.accounts.getUsername()}">Edit</option>
                                <option value="delete-${pageScope.accounts.getUsername()}">Delete</option>
                            </select>
                        </td>
