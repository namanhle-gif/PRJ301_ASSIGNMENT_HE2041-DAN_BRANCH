...
<html>
    ...
    <body>
        <div>
            ...
            <h3>| List of Repair Orders (Admin)</h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <select onchange="handleAction(this)">
                                ...
                                <option value="delete-${pageScope.o.getOrderID()}" style="color: red;">Delete</option>
                            </select>
                        </td>
                    </tr>
                    <% } %>
    ...
    <script>
        function handleAction(select) {
            ...
            if (action === "delete") {
                if (confirm("Warning: Are you sure you want to delete this repair order? This action cannot be undone.")) {
                    window.location = "DeleteOrder?id=" + id;
                } else {
                    document.getElementById('actionSelect_' + id).value = '';
                }
            }
